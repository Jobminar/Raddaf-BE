...
export const validateListingProperty = [
  ...
  body("receptionlength").isInt({ min: 0 }),
  body("receptionwidth").isInt({ min: 0 }),
  body("kitchenlength").isInt({ min: 0 }),
  body("kitchenwidth").isInt({ min: 0 }),
  body("masterBedroomlength").isInt({ min: 0 }),
  body("masterBedroomwidth").isInt({ min: 0 }),
  body("bedroomlength").isInt({ min: 0 }),
  body("bedroomwidth").isInt({ min: 0 }),
